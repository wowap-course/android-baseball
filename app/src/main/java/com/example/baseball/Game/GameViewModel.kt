...
class GameViewModel(private val initialLife: Int) : ViewModel() {
    ...
    fun game(inputNumber: List<Int>) {
        val abc = "Abc"
        Log.d(abc,"randomNumber = $randomNumber")
    ...
    companion object {
        ...
        class GameViewModelFactory(val life: Int) : ViewModelProvider.Factory {
